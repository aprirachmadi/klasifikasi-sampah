...
# Home Page
if page == "Home":
    st.title("Aplikasi untuk Pemilahan Sampah Organik dan Anorganik")
    st.markdown("""
...
# Main Menu Page
    ...
    st.write("Unggak file atau ambil foto")
    ...
    if button:
        ...
        ## Pemanfaatan sampah Organik.
            Sampah organik dapat diolah menjadi bahan yang berguna melalui beberapa cara, seperti mengompos, pembuatan pelet makanan untuk ayam dan ikan, dan penggunaan sebagai bahan bakar untuk menghasilkan listrik melalui proses biogas. Dengan demikian, pengelolaan sampah organik yang tepat dapat mengurangi volume sampah, menghasilkan kompos yang berguna, dan mengurangi bau tidak sedap serta gas metana.
        """)
        if pred_class == 0:
            st.write("""
    ...
    for i, (pred_class) in enumerate(st.session_state.history):
        st.write(f"{i + 1}. {output_dict[pred_class]}")
